...
public class AttackTable extends JPanel {
    ...
    public AttackTable() {
        ...
        JLabel label0 = new JLabel(AttackTable.MyTableModel.columnNames[4], TroopsDetailPanel.getSpearIcon(), JLabel.CENTER);
        ...
        JLabel label1 = new JLabel(AttackTable.MyTableModel.columnNames[5], TroopsDetailPanel.getSwordIcon(), JLabel.CENTER);
        ...
        JLabel label2 = new JLabel(AttackTable.MyTableModel.columnNames[6], TroopsDetailPanel.getArcherIcon(), JLabel.CENTER);
        ...
        JLabel label3 = new JLabel(AttackTable.MyTableModel.columnNames[7], TroopsDetailPanel.getAxeIcon(), JLabel.CENTER);
        ...
        JLabel label4 = new JLabel(AttackTable.MyTableModel.columnNames[8], TroopsDetailPanel.getMountedArcherIcon(), JLabel.CENTER);
        ...
        JLabel label5 = new JLabel(AttackTable.MyTableModel.columnNames[9], TroopsDetailPanel.getScoutIcon(), JLabel.CENTER);
        ...
        JLabel label6 = new JLabel(AttackTable.MyTableModel.columnNames[10], TroopsDetailPanel.getLightCalIcon(), JLabel.CENTER);
        ...
        JLabel label7 = new JLabel(AttackTable.MyTableModel.columnNames[11], TroopsDetailPanel.getHeavyCalIcon(), JLabel.CENTER);
        ...
        JLabel label8 = new JLabel(AttackTable.MyTableModel.columnNames[12], TroopsDetailPanel.getCatapultIcon(), JLabel.CENTER);
        ...
        JLabel label9 = new JLabel(AttackTable.MyTableModel.columnNames[13], TroopsDetailPanel.getRamIcon(), JLabel.CENTER);
        ...
        JLabel label10 = new JLabel(AttackTable.MyTableModel.columnNames[14], TroopsDetailPanel.getNobleIcon(), JLabel.CENTER);
    ...
    static class MyTableModel extends AbstractTableModel {
        ...
        public  Object[][] data = {
                ...
                {"000000", "Village Village Village",
                        "000", "000", "00000", "000","000", "000", "000", "000", "000", "000", "000", "000", "000", "Travel from"},

                {"000000", "Village Village Village",
                        "000", "000", "0000", "000","000", "000", "000", "000", "000", "000", "000", "000", "000", "Travel from"},
                {"000000", "Village Village Village",
                        "000", "000", "0000", "000","000", "000", "000", "000", "000", "000", "000", "000", "000", "Travel from"},
                {"000000", "Village Village Village",
                        "000", "000", "0000", "000","000", "000", "000", "000", "000", "000", "000", "000", "000", "Travel from"},
