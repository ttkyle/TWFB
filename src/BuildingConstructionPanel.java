...
public class BuildingConstructionPanel extends JPanel {
    ...
    //////////////setters for labels////////////////
    public static void setAssignmentOne(String label) {
        assignmentOne.setText(label);
    }

    public static void setDurationOne(String label) {
        durationOne.setText(label);
    }

    public static void setCompletionOne(String label) {
    ...
    public static void setAssignmentTwo(String label) {
        assignmentTwo.setText(label);
    }

    public static void setDurationTwo(String label) {
        durationTwo.setText(label);
    }

    public static void setCompletionTwo(String label) {
